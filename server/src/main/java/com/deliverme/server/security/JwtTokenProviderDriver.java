...
@Component
public class JwtTokenProviderDriver {
    ...
    public String generateToken(Authentication authentication) {
        ...
        String userId = Long.toString(driver.getId());

        //things we are including in the token
        Map<String, Object> claims = new HashMap<>();
        claims.put("id", (Long.toString(driver.getId())));
        claims.put("username", driver.getUsername());
        claims.put("fullName", driver.getFullName());
        claims.put("type", driver.getType());
